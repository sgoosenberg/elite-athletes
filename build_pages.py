...
def build():
    ...
    page = page.replace('</form>', '</form><aside class="panel" aria-labelledby="roster-heading"><h2 id="roster-heading">Approved athletes</h2><p id="roster-status" role="status">Loading roster…</p><ul id="roster-list"></ul></aside>')
